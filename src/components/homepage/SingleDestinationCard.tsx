...
const SingleDestinationCard = ({
  ...
  return (
    <div className="flex-shrink-0 flex-grow relative w-[250px] h-[250px] md:w-[400px] md:h-[500px] overflow-hidden rounded-lg shadow-sm group p-4 flex items-center justify-center">
      ...
      <div className="border-2 w-full h-full text-center border-white flex flex-col items-center justify-center z-20 duration-100 ease-in-out transition-all opacity-0 group-hover:opacity-100 delay-75">
        <Link href={link}>
